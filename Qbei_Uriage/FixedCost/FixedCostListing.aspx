<%@ Page Title="" Language="C#" MasterPageFile="~/Uriage.Master" AutoEventWireup="true" CodeBehind="FixedCostListing.aspx.cs" Inherits="Qbei_Uriage.FixedCost.FixedCostListing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=gvFixedC.ClientID%> [id*=btnDelete]").click(function () {
                ...
                if (confirm("削除よろしいですか？"))
                {
                    $.ajax({
                        ...
                        url: "FixedCostListing.aspx/FixedCostDelete",
                        ...
                        success: function (msg) {
                            ...
                            {
                                temp.remove();
                                if ($("#<%=gvFixedC.ClientID%> td").length == 0)
                                { }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-custom1" style="margin-top:-40px;">
        <div class="panel-heading" style="width:100%"><span class="glyphicon glyphicon-file">固定費一覧</span></div>
    ...
    <div align="center">
        <asp:GridView runat="server" ID="gvFixedC" AutoGenerateColumns="false" AllowPaging="true" Width="98%"
            ShowHeaderWhenEmpty ="true" CssClass ="table table-striped table-bordered table-hover usd header-m" OnPageIndexChanging="gvFixedC_PageIndexChanging"
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:HiddenField ID ="hdFixedCostId" runat="server" Value ='<%#Bind("FixedCostID") %>' />
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblShop" Text='<%#Bind("ShopCategory") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
