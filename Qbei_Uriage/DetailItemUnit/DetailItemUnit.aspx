<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Uriage.Master" CodeBehind="DetailItemUnit.aspx.cs" Inherits="Qbei_Uriage.DetailItemUnit.DetailItemUnit" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
     ...
     <div class="panel panel-custom1" style="margin-top:-40px;" onload="myFunction()">
               <div class="panel-heading" style="width:100%"><span class="glyphicon glyphicon-file"></span>売上明細一覧</div>
...
<asp:TextBox ID="txtPartNo" runat="server"  width="150px" Height="25px"  CssClass="ddl111"></asp:TextBox>
...
単価
    ...
    <asp:TextBox ID="txtUnitPrice" runat="server"  width="130px" Height="25px"  CssClass="ddl11" onkeypress="return isNumber(event);"></asp:TextBox>
...
数量
    ...
    <asp:TextBox ID="txtQuantity" runat="server"  width="130px" Height="25px"  CssClass="ddl11" onkeypress="return isNumber(event);"></asp:TextBox>
...
標準原価
    ...
    <asp:TextBox ID="txtCost" runat="server"  width="150px" Height="25px"  CssClass="ddl11" onkeypress="return isNumber(event);"></asp:TextBox>
...
金額
    ...
    <asp:TextBox ID="txtAmount" runat="server"  width="130px" Height="25px"  CssClass="ddl11" onkeypress="return isNumber(event);"></asp:TextBox>
...
クーポン
    ...
    <asp:TextBox ID="txtCoupon" runat="server"  width="130px" Height="25px"  CssClass="ddl11" onkeypress="return isNumber(event);"></asp:TextBox>
...
値引き
    ...
    <asp:TextBox ID="txtDiscount" runat="server"  width="130px" Height="25px"  CssClass="ddl11" onkeypress="return isNumber(event);"></asp:TextBox>
...
更新日
    ...
    <%--<asp:TextBox ID="txtModifiedDate" runat="server"  width="130px" Height="25px"  CssClass="ddl11" onkeypress="return allowOnlyNumber(event);"></asp:TextBox>--%>
 ...
 <button id="btnSearch" type="button" class="btn btn-primary ddl111" runat="server" onserverclick="btnSearch_Click"  >
    ...
    <div  align="center">
          <asp:GridView runat="server" ID="gvDetailItemUnit" AutoGenerateColumns="False" 
         AllowPaging="True"  onpageindexchanging="gvDetailItemUnit_PageIndexChanging"  ShowHeaderWhenEmpty="true"
         ...
         <asp:TemplateField>
            ...
            <asp:TemplateField>
             ...
             <asp:TemplateField>
               ...
               <asp:TemplateField>
                <HeaderTemplate >標準原価</HeaderTemplate>
                <HeaderStyle CssClass="text-center"/>
                    <ItemTemplate>
                            ...
                            <div>
                                ...
                                <div class="pull-right">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                Page Size:
                                <asp:DropDownList runat="server" ID="ddlPageSize" AutoPostBack="true" Height="30px" OnSelectedIndexChanged="gvDetailItemUnit_Indexchanged" Width="50px">
