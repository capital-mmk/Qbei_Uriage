<%@ Page Title="" Language="C#" MasterPageFile="~/Uriage.Master" AutoEventWireup="true" CodeBehind="ImportPlaningData.aspx.cs" Inherits="Qbei_Uriage.PlaningData.ImportPlaningData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=txtAmt.ClientID%>").on("keypress keyup", function (e) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-custom1" style="margin-top:-40px;">
        <div class="panel-heading" style="width:100%"><span class="glyphicon glyphicon-file">日別費用予算</span></div>
                ...
                <div class="panel-body" style="padding: 10px 0px 0px 0px; margin-left:10px; margin-top:10px;">
                    <table style="height: 80px; width: 1328px;">
                        <tr>
                            ...
                            <td>勘定科目</td>
                            <td>
                                <asp:TextBox ID="txtFCAccountTitle" runat="server" Width="130px" Height="25px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>金額</td>
                            <td>
                                <asp:TextBox ID="txtAmt" runat="server" Width="130px" Height="25px"></asp:TextBox>
                            </td>
                            <td>部門</td>
                            <td>
                                <asp:DropDownList runat="server" ID="ddlShopCategory" AppendDataBoundItems="true" Width="130px" Height="25px">
                            ...
                            <td>
                                <%--<input type="file" runat="server" id="fileDialog" name ="importFile" accept=".csv" />--%>
                                <asp:FileUpload ID="fileUpload" runat="server" AllowMultiple="false" />
                                <span id="spfileNm" runat="server" style="text-align:left; color:#fc0a26;"></span>
                            </td>
                            <td>
                                <button id="btnImport" runat="server" class="btn btn-primary ddl111" type="button" onserverclick="btnImport_Click" >
                                    <span class="glyphicon glyphicon-file" aria-hidden="true" style="vertical-align:middle;"></span>&nbsp;&nbsp;
                                    Csv取込
                                </button>
    ...
    <div align="center">
        <asp:GridView runat="server" ID="gvPlaning" AutoGenerateColumns="false" AllowPaging="true" Width="98%"
            ShowHeaderWhenEmpty ="true" CssClass ="table table-striped table-bordered table-hover usd header-m" OnPageIndexChanging="gvPlaning_PageIndexChanging"
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:Label runat ="server" ID ="lblDate" Text ='<%# DateTime.Parse( Eval("SaleDate").ToString()).ToString ("yyyy/MM/dd") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <HeaderStyle CssClass="text-center" />
                    ...
                    <ItemTemplate>
                        <asp:Label ID ="lblFAcc" runat="server" Text ='<%#Bind("AccountTitle") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <HeaderStyle CssClass="text-center" />
                    ...
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblAmt" Text='<%# decimal.Parse (Eval("Amount").ToString()) == 0 ? "0" : Eval("Amount","{0:#,###.#####}")  %>'></asp:Label>&nbsp;円
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <HeaderStyle CssClass="text-center" />
                    ...
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblShop" Text='<%#Bind("Category") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
