<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEntry.aspx.cs" MasterPageFile="~/Uriage.Master" Inherits="Qbei_Uriage.UserList.UserEntry" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    width: 111%;" align="center">Registration Form 
		</div>
						<form  id="form1">
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control required" runat="server" name="name" id="txtUserName"  placeholder="Enter your Name"/>
								</div>
							</div>
						</div>

                    	<div class="form-group" runat="server" id="old_pass_div">
							<label for="username" class="cols-sm-2 control-label" runat="server" id="change_name">最後のパスワード</label>
							<div class="cols-sm-10">
								<div class="input-group">
						...
						<div class="form-group" runat="server" id="new_hide">
						...
						<div class="form-group" runat="server" id="con_hide">
						...
						<div class="form-group" runat="server" style="display:none;">
							...
							<div class="cols-sm-10 ">
								<div class="input-group ">
									...
									<input type="text" runat="server" maxlength="10" onkeydown = "return DateFormat(this, event.keyCode)"  onblur="myFunction()" class="form-control form_date" name="confirm" id="txtModifiedDate"  placeholder="yyyy/mm/dd"/>
								</div>
							</div>
						</div>
                            </form>
						<div class="form-group ">
                            ...
                            <input type="button" id="btnsave"  runat="server"   class="btn btn-primary btn-lg btn-block login-button" value="Save" onserverclick="Save_Click" />
						</div>
