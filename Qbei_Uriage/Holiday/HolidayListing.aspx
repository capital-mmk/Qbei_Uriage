<%@ Page Title="" Language="C#" MasterPageFile="~/Uriage.Master" AutoEventWireup="true" CodeBehind="HolidayListing.aspx.cs" Inherits="Qbei_Uriage.Holiday.HolidayListing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $("#<%=gvHoliday.ClientID%> [id*=btnDelete]").click(function () {
                ...
                if (confirm("削除よろしいですか？"))
                {
                    $.ajax({
                        ...
                        url: "HolidayListing.aspx/HolidayDelete",
                        ...
                        success: function (msg) {
                            ...
                            {
                                temp.remove();
                                if ($("#<%=gvHoliday.ClientID%> td").length == 0)
                                { }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-custom1" style="margin-top:-40px;">
        <div class="panel-heading" style="width:100%"><span class="glyphicon glyphicon-file">休業日一覧</span></div>
                ...
                <div class="panel-body" style="padding: 10px 0px 0px 0px; margin-left:10px; margin-top:10px;">
                    <table style="height: 80px; width: 100%;">
                        <tr>
                            ...
                            <td>休業日</td>
                            <td>
                                <asp:TextBox ID="txtHName" runat="server" Width="130px" Height="25px"></asp:TextBox>
                            </td>
                            <td>
    ...
    <div align="center">
        <asp:GridView ID ="gvHoliday" runat ="server" AutoGenerateColumns="false" AllowPaging ="true" Width="98%"
            ShowHeaderWhenEmpty ="true" CssClass ="table table-striped table-bordered table-hover usd header-m" OnPageIndexChanging="gvHoliday_PageIndexChanging"
            ...
            <Columns>
                <asp:TemplateField >
                    ...
                    <ItemTemplate>
                        <asp:HiddenField runat="server" ID ="hdHolidayId" Value ='<%#Bind("HolidayID") %>' />
                        <asp:Label runat="server" ID ="lblHolidayDate" Text ='<%#Bind("HolidayDate","{0:yyyy/MM/dd}") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <HeaderStyle CssClass="text-center" />
                    <HeaderTemplate>休業日</HeaderTemplate>
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblHolidayName" Text ='<%#Bind("HolidayName") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
