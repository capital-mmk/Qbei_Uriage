<%@ Page Title="" Language="C#" MasterPageFile="~/Uriage.Master" AutoEventWireup="true" CodeBehind="InsuranceListing.aspx.cs" Inherits="Qbei_Uriage.InsuranceMaster_List.InsuranceListing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type ="text/javascript">
        $(document).ready(function () {
            $("#<%=gvInsurance.ClientID%> [id*=btnDelete]").click(function () {
                ...
                if (confirm("削除よろしいですか？"))
                {
                    $.ajax({
                        ...
                        url: "InsuranceListing.aspx/InsuranceDelete",
                        ...
                        success: function (msg) {
                            if (msg.d == "Ok") {
                                temp.remove();
                                if ($("#<%=gvInsurance.ClientID%> td").length == 0) {
            ...
            $("#<%=txtPer.ClientID%>").on("keypress keyup", function (e) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-custom1" style="margin-top:-40px;">
        <div class="panel-heading" style="width:100%"><span class="glyphicon glyphicon-file">法定福利費一覧</span></div>
                ...
                <div class="panel-body" style="padding: 10px 0px 0px 0px; margin-left:10px; margin-top:10px;">
                    <table style="height: 80px; width: 1328px;">
                        <tr>
                            ...
                            <td>割合</td>
                            <td>
                                <asp:TextBox ID="txtPer" runat="server" Width="130px" Height="25px"></asp:TextBox>&nbsp;%
                            </td>
                            <td>開始日付</td>
                            <td>
                                <div runat="server" class="input-group date form_date col-md-1" data-date="" data-date-format="yyyy mm dd" data-link-field="dtpSD" data-link-format ="yyyy-mm-dd">
                        ...
                        <tr>
                            <td>終了日付</td>
                            <td>
                                <div id="Div1" runat="server" class="input-group date form_date col-md-1" data-date="" data-date-format="yyyy mm dd" data-link-field="dtpED" data-link-format ="yyyy-mm-dd">
    ...
    <div align="center" >
        <asp:GridView runat="server" ID ="gvInsurance" AutoGenerateColumns="false" AllowPaging="true" Width="98%"
            ShowHeaderWhenEmpty ="true" CssClass ="table table-striped table-bordered table-hover usd header-m" OnPageIndexChanging="gvInsurance_PageIndexChanging"
            ...
            <Columns>
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        <asp:HiddenField ID ="hdInsuranceId" runat="server" Value='<%#Bind("InsuranceID") %>' />
                        <asp:Label runat="server" ID ="lblIAcc" Text ='<%#Bind("AccountTitle") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>     
                <asp:TemplateField >
                    ...
                    <HeaderStyle CssClass="text-center" />
                    <ItemTemplate>
                        <asp:Label runat ="server" ID="lblIPercent" Text='<%#(decimal.Parse (Eval("Percent").ToString()) * 100).ToString("###") + " %" %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField>
                    ...
                    <HeaderStyle CssClass="text-center" />
                    <ItemTemplate>
                        <asp:Label runat ="server" ID ="lblIStartDT" Text='<%#Bind("Expire_SDate","{0:yyyy/MM/dd}") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    ...
                    <HeaderStyle CssClass="text-center" />
                    <ItemTemplate>
                        <asp:Label runat="server" ID ="lblIEndDT" Text='<%#Bind("Expire_EDate","{0:yyyy/MM/dd}") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
